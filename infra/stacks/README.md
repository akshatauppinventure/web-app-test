...
| `core` | VPS-B (local) | `core/compose.yaml` | postgres (no ports, `db` internal network), migrate (one-shot), keycloak (`10.10.0.2:8080`), backend (`10.10.0.2:8000`) |
...
| core | `CORE_BIND_IP` | optional; default `10.10.0.2` |
