...
| P6 | T18 | **UpCloud account**, payment method, an **API token** (server + network + storage permissions) — **done 2026-09-17** | `~/.config/upcloud/token` → `UPCLOUD_TOKEN` for OpenTofu (never committed) |
